...
class Page : public QWidget
{
  Q_OBJECT
public:
  explicit Page(Page * parentPage, GingaPage *gingaPage, const QString &execPath,
                QString title = "", QString description = "",
                QString language = "en",
                QList <MenuItem *> items = QList <MenuItem *>(),
                QWidget *parent = 0);
...
private:
  void setupLayout (Page *parentPage, GingaPage *gingaPage, QString title,
                    QString description, QString language);
